...
export interface IQOptionBinary {
    actives: {
        [key: string]: IQOptionBinaryActive;
    };
    list: any[];
}
...
export interface IQOptionPurpleOption {
    ...
    exp_time: number;
    bet_close_time: {
        [key: string]: IQOptionPurpleBetCloseTime;
    };
    count: number;
    special: any[] | {
        [key: string]: IQOptionSpecialValue;
    };
    start_time: number;
}
...
export declare enum IQOptionTitleEnum {
...
export declare enum IQOptionProvider {
    Feed = "feed",
    Otc = "OTC"
}
export interface IQOptionTurbo {
    actives: {
        [key: string]: IQOptionTurboActive;
    };
    list: any[];
}
...
export interface IQOptionFluffyOption {
    ...
    exp_time: number;
    bet_close_time: {
        [key: string]: IQOptionFluffyBetCloseTime;
    };
    count: number;
    special: any[];
    start_time: number;
